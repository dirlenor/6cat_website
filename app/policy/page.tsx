    ...
    <SiteScaffold>
      <main className="min-h-screen bg-background-dark text-text-dark px-6 md:px-12 py-24">
        ...
        <div className="flex flex-col gap-6">
          <a
            href="/"
            className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-4 py-2 text-xs font-semibold uppercase tracking-[0.25em] text-white/80 hover:bg-white/20 transition-colors"
          >
            <span className="text-base">←</span>
            Back to Home
          </a>
          <p className="text-xs uppercase tracking-[0.35em] text-primary">Policy</p>
        </div>
        <h1 className="mt-4 text-4xl md:text-6xl font-display font-bold text-white">
          Privacy Policy
        </h1>
        <p className="mt-3 text-sm text-white/60">Last updated: January 17, 2026</p>

        <div className="mt-10 space-y-6 text-sm md:text-base text-white/80 leading-relaxed">
          <p>
          ...
          <h2 className="pt-6 text-2xl md:text-3xl font-display font-semibold text-white">
            Interpretation and Definitions
          </h2>
          <h3 className="text-xl font-display font-semibold text-white">Interpretation</h3>
          <p>
            The words whose initial letters are capitalized have meanings defined under the
            following conditions. The following definitions shall have the same meaning regardless
            of whether they appear in singular or in plural.
          </p>
          <h3 className="text-xl font-display font-semibold text-white">Definitions</h3>
          <p>For the purposes of this Privacy Policy:</p>
          <ul className="list-disc pl-6 space-y-3">
            <li>
              <strong className="text-white">Account</strong> means a unique account created for You
              to access our Service or parts of our Service.
            </li>
            <li>
              <strong className="text-white">Affiliate</strong> means an entity that controls, is
            ...
            <li>
              <strong className="text-white">Company</strong> (referred to as either "the Company",
              "We", "Us" or "Our" in this Agreement) refers to 6CAT Agency, Thasai Nonthaburi 11000.
            </li>
            <li>
              <strong className="text-white">Cookies</strong> are small files that are placed on
            ...
            <li>
              <strong className="text-white">Country</strong> refers to: Thailand.
            </li>
            <li>
              <strong className="text-white">Device</strong> means any device that can access the
              Service such as a computer, a cell phone or a digital tablet.
            </li>
            <li>
              <strong className="text-white">Personal Data</strong> is any information that relates
            ...
            <li>
              <strong className="text-white">Service Provider</strong> means any natural or legal
              ...
              provide the Service on behalf of the Company, to perform services related to the
              Service or to assist the Company in analyzing how the Service is used.
            </li>
            <li>
              <strong className="text-white">Usage Data</strong> refers to data collected
              automatically, either generated by the use of the Service or from the Service
              infrastructure itself (for example, the duration of a page visit).
            </li>
            <li>
              <strong className="text-white">Website</strong> refers to 6CAT, accessible from{" "}
              <a
                className="text-primary underline underline-offset-4"
                href="http://6cat-agency.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                http://6cat-agency.com
              </a>
              .
            </li>
            <li>
              <strong className="text-white">You</strong> means the individual accessing or using
          ...
          <h3 className="text-xl font-display font-semibold text-white">Types of Data Collected</h3>
          ...
          <ul className="list-disc pl-6 space-y-3">
            <li>
              <strong className="text-white">Cookies or Browser Cookies.</strong> A cookie is a
            ...
            <li>
              <strong className="text-white">Web Beacons.</strong> Certain sections of our Service
          ...
          <ul className="list-disc pl-6 space-y-4">
            <li>
              <p className="text-white font-semibold">Necessary / Essential Cookies</p>
            ...
            <li>
              <p className="text-white font-semibold">Cookies Policy / Notice Acceptance Cookies</p>
            ...
            <li>
              <p className="text-white font-semibold">Functionality Cookies</p>
              <p>Type: Persistent Cookies</p>
              <p>Administered by: Us</p>
              <p>
          ...
          <h3 className="text-xl font-display font-semibold text-white">Use of Your Personal Data</h3>
          <p>The Company may use Personal Data for the following purposes:</p>
          <ul className="list-disc pl-6 space-y-3">
            <li>
              <strong className="text-white">To provide and maintain our Service</strong>, including
              to monitor the usage of our Service.
            </li>
            <li>
              <strong className="text-white">To manage Your Account:</strong> to manage Your
            ...
            <li>
              <strong className="text-white">For the performance of a contract:</strong> the
            ...
            <li>
              <strong className="text-white">To contact You:</strong> To contact You by email,
            ...
            <li>
              <strong className="text-white">To provide You</strong> with news, special offers, and
              general information about other goods, services and events which We offer that are
              similar to those that you have already purchased or inquired about unless You have
              opted not to receive such information.
            </li>
            <li>
              <strong className="text-white">To manage Your requests:</strong> To attend and manage
              Your requests to Us.
            </li>
            <li>
              <strong className="text-white">For business transfers:</strong> We may use Your
            ...
            <li>
              <strong className="text-white">For other purposes</strong>: We may use Your
          ...
          <ul className="list-disc pl-6 space-y-3">
            <li>
              <strong className="text-white">With Service Providers:</strong> We may share Your
              personal information with Service Providers to monitor and analyze the use of our
              Service, to contact You.
            </li>
            <li>
              <strong className="text-white">For business transfers:</strong> We may share or
            ...
            <li>
              <strong className="text-white">With Affiliates:</strong> We may share Your
            ...
            <li>
              <strong className="text-white">With business partners:</strong> We may share Your
              information with Our business partners to offer You certain products, services or
              promotions.
            </li>
            <li>
              <strong className="text-white">With other users:</strong> when You share personal
            ...
            <li>
              <strong className="text-white">With Your consent</strong>: We may disclose Your
              personal information for any other purpose with Your consent.
            </li>
          </ul>
          <h3 className="text-xl font-display font-semibold text-white">Retention of Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-xl font-display font-semibold text-white">Transfer of Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-xl font-display font-semibold text-white">Delete Your Personal Data</h3>
          <p>
          ...
          <h3 className="text-xl font-display font-semibold text-white">Disclosure of Your Personal Data</h3>
          ...
          <h3 className="text-xl font-display font-semibold text-white">Security of Your Personal Data</h3>
          <p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>By email: thanawat.siriwisitthana@gmail.com</li>
          </ul>
        </div>
        </div>
      </main>
