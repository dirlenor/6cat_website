...
export default function TimelineSection({ t }: TimelineSectionProps) {
  return (
    <section className="relative z-10 w-full px-6 md:px-12 pb-24 pt-0 bg-background-light dark:bg-background-dark">
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <h2 className="mt-4 text-4xl md:text-6xl font-display font-bold text-black dark:text-white leading-tight">
            {t.timeline.title}
          </h2>
        ...
        <div className="mt-8 max-w-3xl mx-auto rounded-3xl border border-gray-200 dark:border-neutral-800 bg-black/90 dark:bg-neutral-900 p-6 text-white text-center">
